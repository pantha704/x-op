# DRAFT QUEUE — posts awaiting owner review

*(append-only; new items at the bottom; keep the item format from README.md)*

---

**RESET 2026-09-23 (~08:10Z): all pre-reset drafts cleared on owner order — we start fresh on the new system (voice-fixed scouts + compose-wide worker + quote lane). Old queue archived at `drafts/archive/DRAFT-QUEUE-20260923-pre-reset.md`. From here on, every item must pass the individual-with-experience voice test.**
...
## [DRAFT-QN-20260923-01] question | pending
- target: n/a (original post)
- text: "gpt 6 sol or opus 5.5, what would you pick"
- media: none
- why: v5 question lane (owner format) - bare pick question, invites real answers
- created: 2026-09-23T10:26:42Z

## [DRAFT-QN-20260923-02] question | pending
- target: n/a (original post)
- text: "gpt 6 sol or opus 5.5 for a long coding session, what would you pick"
- media: none
- why: v5 question lane (owner format) - scenario variant
- created: 2026-09-23T10:26:42Z

## [DRAFT-QN-20260923-03] question | pending
- target: n/a (original post)
- text: "silent hill townfall or control resonant first, what would you pick"
- media: none
