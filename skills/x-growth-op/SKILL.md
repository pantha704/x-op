...
- **Country peak bend (owner directive 2026-09-23):** check UTC before harvest. Tilt ~40% of lanes toward the awake country, still inside the genre lock. India 13:30-17:30 UTC. SF/Pacific is the America bend that matters: 01:00-06:30 UTC local evening, but the active window only catches the tail, so bend hard 06:30-10:00 UTC (SF late night) and 23:00-23:30 UTC (SF afternoon). East Coast 23:00-03:00 is mostly asleep-window, same lanes when it is actually open. China 12:00-16:00 UTC (lang:zh + TW/HK/overseas + CN games on the global timeline; X is thin for mainland). Overlap 13:30-16:00: split India+China. Off-peak: global. Bend is who you reply to, not a fake accent. Unreadable post = skip.
