#!/usr/bin/env python3
"""Round 11 (e-slice): rewind 99 / game name mentions since Sept 20."""
import asyncio, json
...
JOBS = [
    ("rewind_today", "https://x.com/search?q=%22rewind%2099%22%20since%3A2026-09-19&src=typed_query&f=live", SEARCH_JS),
    ("caseoh_today_games", "https://x.com/search?q=caseoh%20since%3A2026-09-20&src=typed_query&f=live", SEARCH_JS),
]
...
async def main():
    ...
    json.dump(out, open("/home/ubuntu/x-op/targets/ctx-e-round11-out.json", "w"), ensure_ascii=False, indent=1)
